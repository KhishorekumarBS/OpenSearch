...
public class MetricTranslatorTests extends OpenSearchTestCase {
    ...
    public void testSumTranslator() throws ConversionException {
        ...
        assertEquals(1, calls.size());
        assertEquals(SqlKind.SUM, calls.get(0).getAggregation().getKind());
        assertEquals("total", calls.get(0).getName());
    }
    ...
    public void testMinTranslator() throws ConversionException {
        ...
        assertEquals(1, calls.size());
        assertEquals(SqlKind.MIN, calls.get(0).getAggregation().getKind());
        assertEquals("min_price", calls.get(0).getName());
    }
    ...
    public void testMaxTranslator() throws ConversionException {
        ...
        assertEquals(1, calls.size());
        assertEquals(SqlKind.MAX, calls.get(0).getAggregation().getKind());
        assertEquals("max_price", calls.get(0).getName());
    }
